class InfoMessage:
    ...
    def get_message(self) -> str:
        """Возвращает текст со всеми значениями"""
...
class Running(Training):
    ...
    def get_spent_calories(self) -> float:
        ...
        minutes = self.duration * self.H_IN_M
...
class SportsWalking(Training):
    ...
    COEF_WEIGHT = 0.035
    MEAN_SPEED_IN_2_AND_HEIGHT = 0.029
    KM_PER_H_IN_M_IN_S = 0.278
    SM_IN_M = 100
    ...
    def get_spent_calories(self) -> float:
        ...
        """
        minutes = self.duration * self.H_IN_M
        height_in_metres = self.height / self.SM_IN_M
        return ((self.COEF_WEIGHT * self.weight
                + ((super().get_mean_speed() * self.KM_PER_H_IN_M_IN_S)**2
                 / height_in_metres)
                * self.MEAN_SPEED_IN_2_AND_HEIGHT * self.weight) * minutes)
...
class Swimming(Training):
    ...
    def get_spent_calories(self) -> float:
        ...
        return ((self.get_mean_speed() + self.MEAN_SPEED_MOVE)
